...
<div class="social">
	<ul class="social-list" aria-label="Social media">
		{#each links as link, i (link.label)}
			<li class="social-icon" use:reveal={{ from: 'left', delay: 1300 + i * 100 }}>
...
<div class="indicator" aria-hidden="true" use:reveal={{ from: 'left', delay: 1600 }}></div>
